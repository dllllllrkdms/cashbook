...
<%
	...
	ArrayList<HashMap<String, Object>> list = statsDao.selectStatsByYear(memberId);
		          			...
		          			<div class="card-body demo-vertical-spacing demo-only-element">
								...
								<table class="table">
									...
									%>
											<tr>
												<td>
													<a href="<%=request.getContextPath()%>/cash/statsByMonth.jsp?year=<%=m.get("year")%>">
														<%=m.get("year")%> 년
													</a>
												</td>
