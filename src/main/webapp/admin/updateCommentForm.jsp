...
<%
	...
	if(commentNo==0){ // adminMain.jsp 에서 넘어왔을 경우 commentNo가 0으로 넘어옴.
		response.sendRedirect(request.getContextPath()+"/admin/insertCommentForm.jsp?helpNo="+request.getParameter("helpNo"));
		return;
	}
